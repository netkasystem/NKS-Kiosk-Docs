...
{
        public virtual DbSet<KioskIntegrateNdppConsented> KioskIntegrateNdppConsented { get; set; }
    ...
    public virtual DbSet<KioskConsentView> KioskConsentView { get; set; }

    public virtual DbSet<KioskConsented> KioskConsented { get; set; }

    public virtual DbSet<KioskContract> KioskContract { get; set; }

    public virtual DbSet<KioskContractAttachment> KioskContractAttachment { get; set; }
    ...
    public virtual DbSet<KioskIntegrateNdpp> KioskIntegrateNdpp { get; set; }
    ...
    {
modelBuilder.Entity<KioskIntegrateNdppConsented>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PRIMARY");

            entity.ToTable("kiosk_integrate_ndpp_consented");

            entity.HasIndex(e => e.CitizenId, "idx_citizen_id");

            entity.HasIndex(e => e.KioskId, "idx_kiosk_id");
            ...
            entity.Property(e => e.PurposeOptionDetail)
                .HasComment("purpose ที่เลือก/ไม่เลือก")
                .HasColumnType("json")
                .HasColumnName("purpose_option_detail");
        });
        ...
        modelBuilder.Entity<Kiosk>(entity =>
        {
            ...
            entity.Property(e => e.KioskImage)
                .HasDefaultValueSql("''")
                .HasColumnName("kiosk_image");
        ...
        modelBuilder.Entity<KioskConsentView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("kiosk_consent_view");
        ...
        modelBuilder.Entity<KioskContract>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PRIMARY");
        ...
        modelBuilder.Entity<KioskContractAttachment>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PRIMARY");
            ...
            entity.Property(e => e.FileName)
                ...
                .HasDefaultValueSql("''")
                .HasColumnName("file_name");
            entity.Property(e => e.KioskContractId)
                .HasColumnType("int(10) unsigned")
                .HasColumnName("kiosk_contract_id");
            entity.Property(e => e.StaffId)
                .HasColumnType("int(10) unsigned")
                .HasColumnName("staff_id");
        });

        modelBuilder.Entity<KioskControlCommand>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PRIMARY");
            ...
            entity.Property(e => e.CommandText)
                .HasComment("Shell script or command text")
                .HasColumnType("text")
            ...
            entity.Property(e => e.CreatedAt)
                ...
                .HasColumnName("created_at");
            entity.Property(e => e.Description)
                .HasComment("Additional description (optional)")
                .HasColumnType("text")
                .HasColumnName("description");
            ...
            entity.Property(e => e.Name)
                .HasMaxLength(100)
                .HasComment("Command name, e.g. \"Open Google\", \"Restart\"")
                .HasColumnName("name");
            entity.Property(e => e.UpdatedAt)
                .HasDefaultValueSql("current_timestamp()")
        ...
        modelBuilder.Entity<KioskControlCommandLog>(entity =>
        {
            ...
            entity.ToTable("kiosk_control_command_log");
        ...
        modelBuilder.Entity<KioskCustomFieldValue>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PRIMARY");
            ...
            entity.Property(e => e.Id)
                .HasColumnType("int(10) unsigned")
                .HasColumnName("id");
            entity.Property(e => e.KioskCustomFieldId)
                .HasMaxLength(100)
                .HasDefaultValueSql("''")
                .HasColumnName("kiosk_custom_field_id");
            entity.Property(e => e.KioskCustomFieldValue1)
                .HasColumnType("text")
                .HasColumnName("kiosk_custom_field_value");
            entity.Property(e => e.KioskId)
                .HasColumnType("int(10) unsigned")
                .HasColumnName("kiosk_id");
        });
        ...
        modelBuilder.Entity<KioskEnrollment>(entity =>
        {
            ...
            entity.ToTable("kiosk_enrollment");
        ...
        modelBuilder.Entity<KioskIntegrateNdpp>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PRIMARY");

            entity.ToTable("kiosk_integrate_ndpp");
            ...
            entity.Property(e => e.Inactive)
                ...
                .HasColumnType("tinyint(1) unsigned")
                .HasColumnName("inactive");
            entity.Property(e => e.NdppPreferenceUrl)
                .HasMaxLength(500)
                .HasDefaultValueSql("'รายละเอียดสัญญา'")
            ...
            entity.Property(e => e.ServiceName)
                .HasMaxLength(200)
                .HasComment("ชื่อบริการ")
                .HasColumnName("service_name");
            entity.Property(e => e.ServiceStartDate)
                .HasDefaultValueSql("current_timestamp()")
                .HasComment("วันที่เริ่ม เปิดบริการ")
                .HasColumnType("datetime")
                .HasColumnName("service_start_date");
            entity.Property(e => e.ServiceStopDate)
                .HasDefaultValueSql("current_timestamp()")
                .HasComment("วันที่เริ่ม ปิดให้บริการ")
                .HasColumnType("datetime")
                .HasColumnName("service_stop_date");
            entity.Property(e => e.UpdatedBy)
                .HasColumnType("int(10) unsigned")
                .HasColumnName("updated_by");
            entity.Property(e => e.UpdatedDate)
        ...
        modelBuilder.Entity<KioskSetup>(entity =>
        {
            ...
            entity.Property(e => e.UpdatedAt)
                ...
                .HasColumnType("timestamp")
                .HasColumnName("updated_at");
            entity.Property(e => e.UrlRegion)
                .HasMaxLength(255)
                .HasColumnName("url_region");
